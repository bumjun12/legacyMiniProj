...
public class FileProcess {
	...
	public BoardUpFilesVODTO saveFileToRealPath(byte[] upfile, String realPath, String conteneType, String originalFileName,
...
//				System.out.println("이미지 입니다 ... 썸네일 만듭시다");
...
//				System.out.println(result.toString());
	...
	private String makeBase64String(String thumNailFileName) throws IOException {
		// 썸네일 이미지 -> base64
		String result = null;
		
		// 썸네일 파일의 경로로 File 객체 생성
		File thumb = new File(thumNailFileName);
		
		// thumb File 객체가 가리키는 파일을 읽어와서 byte[]로 반환
